...
// Node/Electron/Expo concern; on Bare you use @qvac/core directly, so the Bare
...
function notAvailable() {
  throw new Error('@qvac/sdk RPC client is not available on Bare; use @qvac/core directly.')
}

...
const completionClientParamsBaseSchema = completionParamsSchema.extend({
  ...
  toolDialect: toolDialectSchema
    .optional()
    .describe(
      "Override auto-detected tool-call dialect. Use when core's name-based detection picks the wrong parser chain for your model."
    ),

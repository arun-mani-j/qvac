...
const translateRequestIdField = z
  ...
  .optional()
  .describe(
    'Stable identifier for this in-flight translation, generated by the caller at call time. Surfaces on the registry so callers can target it with `cancel({ requestId })`. Optional — core falls back to a generated id when the field is missing.'
  )

...
export const downloadAssetRequestSchema = z
  .object({
    ...
    requestId: z
      ...
      .optional()
      .describe(
        'Stable identifier for this in-flight download, generated by the caller at call time. Optional — core falls back to a generated id when the field is missing. Exposed on the decorated promise so callers can target this download with `cancel({ requestId })`.'
      )
  })
  .transform((data) => ({
    ...data,
